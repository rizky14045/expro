...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            ...
            <li class="breadcrumb-item active">Tambah Data Inspeksi</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.inspection.store')}}" class="my-4" enctype="multipart/form-data" method="POST">
                    @csrf
                    <!-- Formulir Pendaftaran -->
                    <div class="col-xl-12">
                        <div class="form-group mb-3 col-md-6">
                            <label for="username" class="form-label">Nomor Form</label>
                            <input class="form-control" name="number_inspection" type="text" id="username" required="" placeholder="Masukan nomor form" value="{{old('number_inspection')}}">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="objectName" required="" placeholder="Masukan jenis objek yang diuji" name="object_name" value="{{old('object_name')}}">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="objectPlace" required="" placeholder="Masukan lokasi objek yang diuji" name="object_location" value="{{old('object_location')}}">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input type="date" class="form-control" name="next_test_date" value="{{old('next_test_date')}}">
