    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="d-flex justify-content-end pe-3 pt-3">
                <a href="{{route('user.evaluation.create')}}" class="btn btn-success">Tambah Data</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Jadwal Verifikasi Lapangan</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{route('user.evaluation.edit')}}" class="btn btn-primary btn-sm">Edit</a>
