                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" id="objectName" required="" placeholder="Masukan nama personel" name="license_name" value="{{$license->license_name}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" id="objectName" required="" placeholder="Masukan klasifikasi" name="clasification" value="{{$license->clasification}}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" id="objectPlace" required="" placeholder="Masukan keterangan status" name="status" value="{{$license->status}}">
