...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Permohonan SKP Baru</h4>
    </div>

    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            <li class="breadcrumb-item"><a href="{{route('user.home.index')}}">Dashboard</a></li>
            <li class="breadcrumb-item active">Tambah Data Permohonan SKP Baru</li>
        </ol>
    </div>
</div>
<div class="row">
                ...
                <form action="index.html" class="my-4">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            <label for="emailaddress" class="form-label">File Permohonan SKP Baru</label>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <div class="d-flex gap-3 justify-content-end">
                                    ...
                                    <a href="{{route('user.license.index')}}" class="btn btn-success"> Back</a>
