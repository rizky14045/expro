        ...
        <div class="account-page">
            <div class="container-fluid p-0">
                <div class="row align-items-center g-0">
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4" style="background-image: url('{{asset('login-bg.jpg')}}');background-repeat: no-repeat;background-size: cover;">
                        ...
                        <div class="row">
                            <div class="col-md-7 mx-auto">
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        <form action="{{route('getLogin')}}" class="my-4" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-group d-flex mb-3">
                                                <div class="col-sm-6">
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input" id="checkbox-signin" value="1" name="remember">
