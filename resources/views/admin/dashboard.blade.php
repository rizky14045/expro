                ...
                <div class="card bg-success text-white">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="fs-14 mb-1">Jumlah User</div>
                        </div>
                        <div class="d-flex align-items-baseline mb-2">
                            <div class="fs-22 mb-0 me-2 fw-semibold">{{number_format($user)}}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline mb-2">
                            <div class="fs-22 mb-0 me-2 fw-semibold">{{number_format($license_accept)}}</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="card bg-info text-white">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline mb-2">
                            <div class="fs-22 mb-0 me-2 fw-semibold">{{number_format($license_process)}}</div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-md-6 col-xl-3">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline mb-2">
                            <div class="fs-22 mb-0 me-2 fw-semibold">{{number_format($license_revision)}}</div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-md-6 col-xl-3">
                <div class="card bg-danger text-white">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline mb-2">
                            <div class="fs-22 mb-0 me-2 fw-semibold">{{number_format($license_reject)}}</div>
                        </div>
                    </div>
                </div>
            </div> 
